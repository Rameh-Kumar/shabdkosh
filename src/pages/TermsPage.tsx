    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="prose dark:prose-invert max-w-none">
        <section className="mb-8">
          ...
          <p>
            By accessing and using Shabdkosh, you accept and agree to be bound by the terms and
        ...
        <section className="mb-8">
          <h2>2. Use License</h2>
          <p>
            Permission is granted to temporarily download one copy of Shabdkosh for personal,
        ...
        <section className="mb-8">
          <h2>5. Limitations</h2>
          <p>
            In no event shall Shabdkosh be liable for any damages arising out of the use or inability
            to use the service.
          </p>
        </section>
